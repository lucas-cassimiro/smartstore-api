...
var orderItems_exports = {};
__export(orderItems_exports, {
  default: () => orderItems_default
});
module.exports = __toCommonJS(orderItems_exports);
...
// src/routes/orderItems/index.ts
var orderItemsRoutes = import_express.default.Router();
